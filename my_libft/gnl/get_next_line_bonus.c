...
/*   Updated: 2024/06/24 11:06:15 by mtrullar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incs/get_next_line_bonus.h"

int	ft_size_to_del(gnl_list **node, gnl_list **to_del)
{
	int		i;
	gnl_list	*current_node;
...
char	*ft_read_fail(char **buffer, gnl_list **node, gnl_list **to_del)
{
	free(*buffer);
